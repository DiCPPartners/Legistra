    ...
    <aside className="hidden w-72 flex-shrink-0 flex-col border-r border-slate-200/50 bg-white/90 backdrop-blur-sm text-[#1f2933] shadow-xl md:flex h-screen overflow-hidden">
      ...
      <div className="flex items-center justify-between border-b border-slate-200/50 px-5 py-5">
        ...
        <button
          ...
          className="inline-flex h-9 w-9 items-center justify-center rounded-xl border border-slate-200 bg-white text-slate-600 shadow-sm transition-all hover:border-[#7B1F34] hover:bg-[#7B1F34] hover:text-white hover:shadow-md"
      ...
      <div className="relative flex flex-1 flex-col">
              ...
              return (
                <div
                  ...
                  className={`group relative flex w-full items-center rounded-xl border px-4 py-3 transition-all ${
                    isActive
                      ? 'border-[#7B1F34]/30 bg-gradient-to-r from-[#7B1F34]/10 to-[#9E3A50]/5 text-slate-800 shadow-md shadow-[#7B1F34]/10'
                ...
                >
                  {editingId === conversation.id ? (
                    <input
                      ...
                      className="mr-3 w-full truncate rounded-lg border border-[#7B1F34] bg-white px-3 py-1.5 text-sm font-semibold text-slate-700 shadow-lg outline-none focus:ring-2 focus:ring-[#7B1F34]/20"
                      maxLength={120}
        ...
        <div className="sticky inset-x-0 bottom-0 space-y-3 border-t border-slate-200/50 bg-white/80 px-5 pb-6 pt-4 backdrop-blur-sm">
          ...
          <button
            ...
            className="group flex w-full items-center justify-between rounded-xl border border-slate-200 bg-white px-5 py-4 text-sm text-slate-600 shadow-sm transition-all hover:border-[#7B1F34] hover:bg-gradient-to-r hover:from-[#7B1F34]/5 hover:to-[#9E3A50]/5 hover:text-[#7B1F34] hover:shadow-md"
          >
            <div className="flex items-center gap-3">
              <span className="inline-flex h-11 w-11 items-center justify-center rounded-lg bg-gradient-to-br from-[#7B1F34]/10 to-[#9E3A50]/10 text-[#7B1F34] shadow-sm transition-all group-hover:from-[#7B1F34]/20 group-hover:to-[#9E3A50]/20">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="h-5 w-5">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z" />
                </svg>
              </span>
              <div className="flex flex-col items-start text-left">
                <span className="font-semibold text-slate-700 group-hover:text-[#7B1F34] transition-colors">Templates</span>
                <span className="text-xs text-slate-400">Emula i tuoi pareri</span>
              </div>
            </div>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="h-5 w-5 text-slate-400 group-hover:text-[#7B1F34] transition-colors">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col items-start text-left">
                <span className="font-semibold text-slate-700 group-hover:text-[#7B1F34] transition-colors">Legislazione</span>
